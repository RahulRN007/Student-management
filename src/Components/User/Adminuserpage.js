...
function Adminuserpage() {
  return (
    <div className='Adminuserpage-main'>
      <div className='Adminuserpage-navbar-main'>
      ...
      <div className='Adminuserpage-mid'>
        <div className='Adminuserpage-mid-first'>        
          <h1 className='Adminuserpage-mid-first-learn'>Learn</h1> <h1 className='Adminuserpage-mid-first-lead'>Lead</h1> <h1 className='Adminuserpage-mid-first-succeed'>Succeed</h1>
        ...
        <div className='Adminuserpage-mid-second'> 
